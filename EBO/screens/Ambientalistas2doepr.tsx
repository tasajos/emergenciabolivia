...
type Props = StackScreenProps<RootStackParamList, 'Ambientalistas2doepr'>; // Cambiado de NativeStackScreenProps a StackScreenProps


//const Educacion2doepr: React.FC<Props> = ({ route, navigation }) => {
    const Ambientalistas2doepr: React.FC<Props> = ({ route, navigation }) => {
    ...
    <>
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Ambientalistas {unidad.name}</Text>
         ...
         {isValidLocation ? (
          ...
          >
            <Marker
              ...
              title={`Ambientalistas ${unidad.name}`}
...
export default Ambientalistas2doepr;
