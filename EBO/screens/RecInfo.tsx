...
const RecInfo: React.FC<Props> = ({ navigation }) => {
  ...
  }, [searchQuery, isFirstLoad]); // La dependencia [searchQuery] asegura que el efecto se ejecute de nuevo cuando cambie la búsqueda.
...
const styles = StyleSheet.create({
  ...
  clearIcon: {
    ...
    floatingButtonBarContainer: {
      height: '10%', // Define la altura del contenedor de FloatingButtonBar
      justifyContent: 'center',
      backgroundColor: 'transparent', // Puedes definir un color de fondo para que se destaque
      // Si necesitas sombra o cualquier otro estilo para FloatingButtonBar, lo defines aquí
    },
