...
type RootStackParamList = {
  ...
  useEffect(() => {
    ...
    obtenerFechaHora();
    const intervalo = setInterval(obtenerFechaHora, 1000); // Actualiza la hora cada segundo
    ...
    try {
      ...
      await newEventRef.set({
       // Titulo,
        descripcion,
        estado,
        fecha: fechaActual, // Envía la fecha actual
        hora: horaActual, // Envía la hora actual
        imagen: imageUrl,
