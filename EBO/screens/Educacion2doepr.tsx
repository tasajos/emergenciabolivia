...
type Props = StackScreenProps<RootStackParamList, 'Educacion2doepr'>; // Cambiado de NativeStackScreenProps a StackScreenProps
    ...
    <>
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Educacion {unidad.name}</Text>
...
export default Educacion2doepr;
